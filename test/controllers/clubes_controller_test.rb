...
class ClubesControllerTest < ActionController::TestCase
  ...
  test "should create clube" do
    assert_difference('Clube.count') do
      post :create, clube: { descricao: @clube.descricao, email: @clube.email, nome: @clube.nome, presidente: @clube.presidente }
    end
  ...
  test "should update clube" do
    patch :update, id: @clube, clube: { descricao: @clube.descricao, email: @clube.email, nome: @clube.nome, presidente: @clube.presidente }
    assert_redirected_to clube_path(assigns(:clube))
  end
